...
public class Reader {
    ...
    private static final Pattern TITLE_TAG =
        Pattern.compile("\\<div id=\"ctl00_Resultado_ResultadoGaleriaUC1_rptBusca_ct.*\\\" class=\"listagem_foto\">(.*)\\</div><div id=\"ctl00_Resultado_ResultadoGaleriaUC1_rptBusca_ct", Pattern.CASE_INSENSITIVE|Pattern.DOTALL);
 ...
 System.out.println(content);
    ...
    public static void main(String ar[]){
    	String title;
		try {
			title = Reader.getPageTitle("http://www.wimoveis.com.br/df/brasilia/apartamento/aluguel?busca=galeria&quarto=todos&o=F&planta=1&pronto=1");
